...
*** Variable ***
${zed_log_out_button}   xpath=//ul[@class='nav navbar-top-links navbar-right user-navbar']//a[contains(@href,'logout')]
...
${zed_user_right_navbar_dropdown}    xpath=//ul[@class='nav navbar-top-links navbar-right user-navbar']//li[@class='dropdown user-navbar__item']
...
Zed: login on Zed with provided credentials:
    ...
    Wait Until Element Is Visible    ${zed_user_right_navbar_dropdown}    Zed:Dashboard page is not displayed
